          ...
          <div className="bg-white">
            ...
            <div className="messages-box">
              <div className="list-group rounded-0">
                <User active name="Jason Doe" date="25 Dec" />
                <User name="Jason Doe" date="14 Dec" />
                <User name="Jason Doe" date="9 Nov" />
                <User name="Jason Doe" date="18 Oct" />
                <User name="Jason Doe" date="17 Oct" />
                <User name="Jason Doe" date="2 Sep" />
                <User name="Jason Doe" date="30 Aug" />
                <User name="Jason Doe" date="21 Aug" />
              </div>
            </div>
          </div>
        </div>
